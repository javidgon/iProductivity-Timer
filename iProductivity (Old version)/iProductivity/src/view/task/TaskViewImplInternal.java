...
public class TaskViewImplInternal extends javax.swing.JPanel {
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        ...
        try {
            if (!view.getLabelCounter().getText().equals("0") && !this.getjTextFieldDescription().equals("") && !this.jComboBox1.getSelectedItem().equals("")) {
                ...
                view.getLabelCongratulations().setText("Se ha producido un error. Tiempo? Espacio sin rellenar?.");
            }
    ...
    private void jButtonRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRemoveActionPerformed
        try {
            if (!view.getLabelCounter().getText().equals("0")) {
